...
class BattleEngine:
    ...
    def _damage(self, attacker: BattleGenesisChronicles, defender: BattleGenesisChronicles,
    ...
    def _priority(self, a: BattleGenesisChronicles, b: BattleGenesisChronicles) -> Tuple[BattleGenesisChronicles, BattleGenesisChronicles]:
        """Schnelleres GenesisChronicles greift zuerst an."""
        if a.speed >= b.speed:
            return a, b
        return b, a

    def battle(self, s1: BattleGenesisChronicles, s2: BattleGenesisChronicles,
