...
ATC Marketplace — GenesisChronicles NFT kaufen & verkaufen
...
class Listing:
    listing_id:   str
    token_id:     str           # GenesisChronicles Token-ID
...
class MarketplaceContract(BaseContract):
    ...
    ROYALTY_PERCENT  = 2.5    # 2.5% → GenesisChronicles Creator
    ...
    def list_for_sale(
        ...
        """Listet ein GenesisChronicles-NFT zum Verkauf auf."""
    ...
    def buy(
        ...
        # Royalty → Contract-Owner (= ursprünglicher GenesisChronicles-Creator)
